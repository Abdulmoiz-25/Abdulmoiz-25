...
🔭 Currently deploying **Machine Learning models** (Random Forest, K-Means) using **Streamlit Cloud** and integrating **model explainability with SHAP plots**.  

👯 Looking to collaborate on an **AI-Powered Crop Prediction System** — combining ML with real-world datasets to forecast optimal crop yields.  

🤝 Seeking help with **voice cloning models** (XTTS-v2 / Kokoro82M) and generative AI for **audio-based projects**.  

🌱 Learning **Spring Cloud Microservices**, **CI/CD Pipelines**, **Time Series Forecasting (ARIMA)**, and **Computer Vision (YOLOv11)**.  

💬 Ask me about **Scrum/Agile**, Streamlit deployment, Gradio demos, ML experiments, **React**, **Spring Boot**, or **scikit-learn**.  

⚡ Fun fact: I love debugging late at night — my productivity peaks after midnight 🌙
